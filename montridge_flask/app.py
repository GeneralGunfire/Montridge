...
@app.route("/")
def index():
    return send_from_directory('newlandingpage/dist', 'index.html')

# === SERVE LOGIN APP ===
@app.route('/login')
@app.route('/login/')
def login_page():
    return send_from_directory('login-app/dist', 'index.html')

@app.route('/login/<path:filename>')
def serve_login_assets(filename):
    return send_from_directory('login-app/dist', filename)

# === SERVE DASHBOARD APP ===
@app.route('/dashboard')
@app.route('/dashboard/')
def dashboard_page():
    return send_from_directory('newdashboard/dist', 'index.html')
...
def serve_dashboard_assets(filename):
    return send_from_directory('newdashboard/dist', filename)

# === SERVE ONBOARDING APP ===
@app.route('/onboarding')
@app.route('/onboarding/')
def onboarding():
    return send_from_directory('onboarding/dist', 'index.html')

@app.route('/onboarding/<path:filename>')
def onboarding_static(filename):
    return send_from_directory('onboarding/dist', filename)

# === SERVE SETTINGS APP ===
@app.route('/settings')
@app.route('/settings/')
def settings():
    return send_from_directory('settings/dist', 'index.html')

@app.route('/settings/<path:filename>')
def settings_static(filename):
    return send_from_directory('settings/dist', filename)

# === SERVE INTELLIGENCE (ARTICLE DETAIL) APP ===
@app.route('/intelligence/<int:article_id>')
def intelligence(article_id):
    return send_from_directory('intelligence/dist', 'index.html')

@app.route('/intelligence/<path:filename>')
def intelligence_static(filename):
    return send_from_directory('intelligence/dist', filename)
...
def not_found(e):
    return send_from_directory('pagenotfound/dist', 'index.html'), 404
