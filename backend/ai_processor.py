...
{{
  "summary": "2-4 sentences. State: what happened, who was involved, when, where, specific numbers/casualties/costs. No background, no speculation. Example: 'Iran fired ballistic missiles at three US bases in Iraq on March 15, killing four soldiers and wounding 18 others. The Pentagon confirmed the attack destroyed two radar installations worth $45 million. Oil prices rose 8% to $112 per barrel within two hours as markets reacted to escalation.'",
  "why_it_matters": "2-4 sentences. State the direct, concrete consequence for ordinary people or the world. Include: who is affected, how specifically, quantifiable impact if known. Example: 'Higher oil prices mean petrol costs rise within days at pumps. Countries that import most of their oil — including India, Japan, most of Europe, South Korea — face the biggest impact. For India, oil imports cost $4.2 billion monthly; a sustained conflict pushing prices to $120 could add $800 million monthly to import costs, fueling inflation. Manufacturing costs rise within weeks as transportation prices increase.'",
